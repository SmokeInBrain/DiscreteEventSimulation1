...
{	private:
    ...
    public:
        //Constructors
            StatisticsOut();
            StatisticsOut(double totalSimulationTime, double throughputTime, double idleTime, double queueTime, double processTime, double IOTime, int queueMaxLength, double queueAvgLength);
        //Getters
